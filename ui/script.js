...
/**
 * Called from Python when an update is available.
 * @param {string} latestVersion  - e.g. "1.2.0"
 * @param {string} releaseName    - e.g. "v1.2.0 - Bug fixes"
 * @param {string} releaseUrl     - GitHub release page URL
 */
